...
public class GPS {
	/**
	 * Position projet�e actuelle
	 */
	private Point	CurrentPosition;
	
	/**
	 * Liste des prochains points � parcourir
	 */
	...
	/**
	 * Retourne la case situ�e � <b>direction</b> par rapport � la position actuelle.<br>
	...
	private Point getNeighbour(int direction) {
		...
		if ( nPoint.y >= 0 && nPoint.y < Maze.length
			...
			// Recherche si le nouveau Point n'a pas d�j� �t� r�pertori� dans la liste des Points � Parcourir
			...
			// --f
			// Recherche si le nouveau Point n'a pas d�j� �t� v�rifi�
